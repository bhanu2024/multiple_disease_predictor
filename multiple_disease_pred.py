# -*- coding: utf-8 -*-
"""
Created on Fri Feb 24 13:21:22 2023
...
if (selected == 'Heart Disease Prediction'):
    ...
    if st.button('Heart Disease Test Result'):
        ...
        b = np.array([[age, sex, cp, trestbps, chol, fbs, restecg,thalach,exang,oldpeak,slope,ca,thal]], dtype=float) #  convert using numpy
